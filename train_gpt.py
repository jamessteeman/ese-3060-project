...
class Hyperparameters:
    ...
    num_iterations : int = 5750 #V1 4500 iterations + calculated extra 1250 iters (100-110s more) to hopefully hit val loss metric [untested lol])
